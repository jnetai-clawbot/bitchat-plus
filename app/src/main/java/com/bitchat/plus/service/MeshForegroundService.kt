...
import com.bitchat.plus.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "com.bitchat.plus.service.START"
        const val ACTION_STOP = "com.bitchat.plus.service.STOP"
        const val ACTION_QUIT = "com.bitchat.plus.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.bitchat.plus.service.UPDATE_NOTIFICATION"
    ...
    private val unifiedMeshService: com.bitchat.plus.mesh.MeshService?
    ...
    override fun onCreate() {
        ...
        updateJob = scope.launch {
            com.bitchat.plus.services.AppStateStore.peers
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        when (intent?.action) {
            ACTION_STOP -> {
                ...
                updateJob?.cancel()
                updateJob = null
                try { com.bitchat.plus.services.MessageRouter.tryGetInstance()?.stopOutboxScheduler() } catch (_: Exception) { }

...
object FileUtils {
     ...
     */
    fun messageTypeForMime(mime: String): com.bitchat.plus.model.BitchatMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.bitchat.plus.model.BitchatMessageType.Image
            lower.startsWith("audio/") -> com.bitchat.plus.model.BitchatMessageType.Audio
            else -> com.bitchat.plus.model.BitchatMessageType.File
        }
    }

...
import com.bitchat.plus.mesh.PeerFingerprintManager
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.bitchat.plus.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.bitchat.plus.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.bitchat.plus.noise.southernstorm.protocol.Noise.createDH("25519")
     ...
     */
    fun signPacket(packet: com.bitchat.plus.protocol.BitchatPacket): com.bitchat.plus.protocol.BitchatPacket? {
     ...
     */
    fun verifyPacketSignature(packet: com.bitchat.plus.protocol.BitchatPacket, publicKey: ByteArray): Boolean {

...
import com.bitchat.plus.features.media.ImageUtils
import com.bitchat.plus.ui.ComposerActionSurface
import com.bitchat.plus.ui.ComposerIconSize
import java.io.File
...
fun ImagePickerButton(
    ...
    val takePictureLauncher = rememberLauncherForActivityResult(
        ...
        if (success && !path.isNullOrBlank()) {
            ...
            val outPath = com.bitchat.plus.features.media.ImageUtils.downscalePathAndSaveToAppFiles(context, path)
    ...
    ComposerActionSurface(
        ...
        Icon(
            ...
            contentDescription = stringResource(com.bitchat.plus.R.string.pick_image),
            tint = tint,

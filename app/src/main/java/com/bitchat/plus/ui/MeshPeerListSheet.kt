...
import com.bitchat.plus.core.ui.component.sheet.BitchatSheetCenterTopBar
...
import com.bitchat.plus.favorites.FavoriteRelationship
...
fun MeshPeerListSheet(
    ...
    val wifiAwareConnected by com.bitchat.plus.wifiaware.WifiAwareController.connectedPeers.collectAsStateWithLifecycle()
                ...
                LazyColumn(
                    ...
                    when {
                        conversationStoreState is
                            com.bitchat.plus.services.ConversationStoreState.Loading &&
                        ...
                        conversationStoreState is
                            com.bitchat.plus.services.ConversationStoreState.Error &&
                            conversations.isEmpty() -> {

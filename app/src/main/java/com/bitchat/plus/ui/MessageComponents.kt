...
import com.bitchat.plus.ui.media.FileMessageItem
import com.bitchat.plus.ui.theme.BASE_FONT_SIZE
import com.bitchat.plus.ui.theme.BitchatMotion
import com.bitchat.plus.ui.theme.ChatVisualTokens
import com.bitchat.plus.ui.theme.LocalBitchatPalette
import com.bitchat.plus.ui.theme.MessageBodyTextStyle
import com.bitchat.plus.ui.theme.MessageSenderTextStyle
import kotlinx.coroutines.delay
import java.text.SimpleDateFormat
import java.util.Locale


// VoiceNotePlayer moved to com.bitchat.plus.ui.media.VoiceNotePlayer
...
@Composable
    ...
    if (message.type == BitchatMessageType.Image) {
        com.bitchat.plus.ui.media.ImageMessageItem(
            message = message,
            messages = messages,
            currentUserNickname = currentUserNickname,
            meshService = meshService,
    ...
    if (message.type == BitchatMessageType.Audio) {
        com.bitchat.plus.ui.media.AudioMessageItem(
            message = message,
            currentUserNickname = currentUserNickname,
            meshService = meshService,
            colorScheme = colorScheme,
    ...
    if (message.type == BitchatMessageType.File) {
        ...
        val (overrideProgress, _) = when (val st = message.deliveryStatus) {
            is com.bitchat.plus.model.DeliveryStatus.PartiallyDelivered -> {
        ...
        Column(modifier = modifier.fillMaxWidth()) {
            ...
            val packet = try {
                ...
                if (file.exists()) {
                    ...
                    com.bitchat.plus.model.BitchatFilePacket(
                        fileName = file.name,
                        fileSize = file.length(),
                        mimeType = com.bitchat.plus.features.file.FileUtils.getMimeTypeFromExtension(file.name),
                ...
                Box {
                    if (packet != null) {
                        if (overrideProgress != null) {
                            ...
                            com.bitchat.plus.ui.media.FileSendingAnimation(

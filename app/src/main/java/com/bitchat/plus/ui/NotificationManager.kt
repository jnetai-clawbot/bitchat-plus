...
import com.bitchat.plus.service.ConversationNotificationReceiver
import com.bitchat.plus.services.ContactDirectory
import com.bitchat.plus.services.ConversationListPreferences
    ...
    companion object {
      ...
      private const val GEOHASH_SUMMARY_NOTIFICATION_ID = 998
        ...
        const val ACTION_REPLY_TO_CONVERSATION =
            "com.bitchat.plus.action.REPLY_TO_CONVERSATION"
        const val ACTION_MARK_CONVERSATION_READ =
            "com.bitchat.plus.action.MARK_CONVERSATION_READ"

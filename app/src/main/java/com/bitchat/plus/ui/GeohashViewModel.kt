...
import com.bitchat.plus.geohash.GeohashNostrPrivacyPolicy
import com.bitchat.plus.geohash.LiveLocationPrivacyGate
import com.bitchat.plus.nostr.GeohashMessageHandler
import com.bitchat.plus.nostr.GeohashRepository
import com.bitchat.plus.nostr.NostrBackgroundRuntime
import com.bitchat.plus.nostr.NostrIdentityBridge
import com.bitchat.plus.nostr.NostrProtocol
import com.bitchat.plus.nostr.NostrRelayManager
import com.bitchat.plus.nostr.NostrSubscriptionManager
import com.bitchat.plus.nostr.PoWPreferenceManager
import com.bitchat.plus.nostr.GeohashAliasRegistry
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.bitchat.plus.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.bitchat.plus.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.bitchat.plus.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.bitchat.plus.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.bitchat.plus.model.BitchatMessage(
                    id = tempId,
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.bitchat.plus.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.bitchat.plus.model.BitchatMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.bitchat.plus.geohash.ChannelID?) {
        ...
        when (channel) {
            is com.bitchat.plus.geohash.ChannelID.Mesh -> {
            ...
            is com.bitchat.plus.geohash.ChannelID.Location -> {
                if (locationChannelManager?.canUseSelectedLocationChannel(channel.channel) != true) {
                    ...
                    switchLocationChannel(com.bitchat.plus.geohash.ChannelID.Mesh)
                    return
                }
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        val selectedLocation = selected as? com.bitchat.plus.geohash.ChannelID.Location

package com.bitchat.plus.ui.debug
...
import com.bitchat.plus.services.meshgraph.MeshGraphService
...
import com.bitchat.plus.core.ui.component.sheet.BitchatBottomSheet
import com.bitchat.plus.core.ui.component.sheet.BitchatSheetTopBar
import com.bitchat.plus.core.ui.component.sheet.BitchatSheetTitle
import com.bitchat.plus.util.DistributionInfoProvider
...
fun MeshTopologySection(
    ...
    val wifiAwareConnected by com.bitchat.plus.wifiaware.WifiAwareController.connectedPeers.collectAsState()
...
fun DebugSettingsSheet(
    ...
    val wifiAwareSupported by com.bitchat.plus.wifiaware.WifiAwareController.supported.collectAsState()
    val wifiAwareAvailable by com.bitchat.plus.wifiaware.WifiAwareController.available.collectAsState()
    val wifiAwareSupportStatus by com.bitchat.plus.wifiaware.WifiAwareController.supportStatus.collectAsState()
        ...
        if (isPresented) {
            ...
            while (true) {
                ...
                val devices = entries.map { (address, isClient, rssi) ->
                    ...
                    com.bitchat.plus.ui.debug.ConnectedDevice(
                ...
                try {
                    val ctrl = com.bitchat.plus.wifiaware.WifiAwareController
        ...
        Box(modifier = Modifier.fillMaxWidth()) {
            ...
            item {
                Surface(shape = RoundedCornerShape(12.dp), color = colorScheme.surfaceVariant.copy(alpha = 0.2f)) {
                    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            Icon(Icons.Filled.SettingsEthernet, contentDescription = null, tint = Color(0xFF1A73E8))
            ...
            item {
                Surface(shape = RoundedCornerShape(12.dp), color = colorScheme.surfaceVariant.copy(alpha = 0.2f)) {
                    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                            Icon(Icons.Filled.Devices, contentDescription = null, tint = Color(0xFF1A73E8))
                    ...
                    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                            ...
                            val palette = remember {
                                listOf(
                                    Color(0xFF1A73E8), Color(0xFF007AFF), Color(0xFFFF9500), Color(0xFFFF3B30),
            ...
            item {
                Surface(shape = RoundedCornerShape(12.dp), color = colorScheme.surfaceVariant.copy(alpha = 0.2f)) {
                    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        val running by com.bitchat.plus.wifiaware.WifiAwareController.running.collectAsState()
                        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                        ...
                        Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                            ...
                            AssistChip(
                                onClick = { com.bitchat.plus.wifiaware.WifiAwareController.getService()?.sendBroadcastAnnounce() },
                                enabled = running,
                                label = { Text("Announce") }
                            )
                        }
            ...
            item {
                Surface(shape = RoundedCornerShape(12.dp), color = colorScheme.surfaceVariant.copy(alpha = 0.2f)) {
                    Column(Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
                        ...
                        val p = remember(gcsFpr) { com.bitchat.plus.sync.GCSFilter.deriveP(gcsFpr / 100.0) }
                        val nmax = remember(gcsFpr, gcsMaxBytes) { com.bitchat.plus.sync.GCSFilter.estimateMaxElementsForSize(gcsMaxBytes, p) }
                            ...
                            scanResults.forEach { res ->
                                Surface(shape = RoundedCornerShape(8.dp), color = colorScheme.surface.copy(alpha = 0.6f)) {
                                    Row(Modifier.fillMaxWidth().padding(10.dp), verticalAlignment = Alignment.CenterVertically) {
                                        ...
                                        Text(stringResource(R.string.debug_connect), color = Color(0xFF1A73E8), fontFamily = BitchatFontFamily, modifier = Modifier.clickable {
